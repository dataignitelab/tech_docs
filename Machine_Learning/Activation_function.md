...
활성화함수를 이용하여 선형연산의 연속이 아니라 비선형 연산의 연속으로 전환함으로서 비선형적인 복잡한 문제를 해결할 수 있도록 하는 것이 기본 개념이다. 아래 그림은 뉴런의 구조에 대한 내용으로 뉴런 노드 출력에 activation function을 적용하여 최종 결과를 사용하는 것을 볼 수 있다.
